...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    category: "encode-decode",
    icon: "Link2",
    path: "/tools/encode-decode/url-encode",
    keywords: ["url", "encode", "decode", "query", "uri"],
    priority: "P0",
  },
  {
    slug: "jwt-decoder",
    ...
    category: "encode-decode",
    icon: "KeyRound",
    path: "/tools/encode-decode/jwt-decoder",
    keywords: ["jwt", "token", "decode", "json", "auth"],
    priority: "P0",
  },
  {
    slug: "html-entity",
  ...
  },
  {
    ...
    category: "formatters",
    icon: "FileText",
    path: "/tools/formatters/markdown-preview",
    keywords: ["markdown", "preview", "md", "editor", "format"],
    priority: "P0",
  },
  {
    slug: "code-formatter",
  ...
  },
  {
    ...
    keywords: ["uuid", "v4", "v7", "guid", "generator"],
    priority: "P0",
  },
  {
    slug: "hash-generator",
  ...
  },
  {
    ...
    category: "viewers",
    icon: "Regex",
    path: "/tools/viewers/regex-tester",
    keywords: ["regex", "regexp", "tester", "pattern", "match"],
    priority: "P0",
  },
  {
    slug: "diff-viewer",
    ...
    category: "viewers",
    icon: "GitCompare",
    path: "/tools/viewers/diff-viewer",
    keywords: ["diff", "compare", "text", "code", "patch"],
    priority: "P0",
  },
  {
    slug: "http-status",
